!function () {
    ...
    * ========================= */
    ...
    LightGrid.prototype = {
      ...
      , getDataFromServer: function ( pageIndex, pageSize, sortArray, searchArray ) {
          var paramData = {
              pageIndex: pageIndex,
              pageSize: pageSize,
      ...
      , action_refresh: function ( refreshPageView, refreshSortView, refreshSearchView ) {
          this.getDataFromServer( this.model.pagination.pageIndex, this.model.pagination.pageSize, this.model.sortArray, this.model.searchArray );

          this.options.onDrawing( this.model );

          this.partialView_content( this.model.entityArray, parseInt( this.model.pagination.startRowIndex() ) );
          refreshPageView && this.partialView_page( this.model.pagination );
          refreshSortView && this.partialView_sort( this.model.sortArray );
          refreshSearchView && this.partialView_search( this.model.searchArray );
